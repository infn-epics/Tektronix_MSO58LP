...
# 
# High-performance ASYN driver for measurement-only acquisition
...
epicsEnvSet "NUM_CH"    "4"
epicsEnvSet "NUM_MEAS"  "4"
...
#============================================================
# Measurement Devices (measurement-only mode)
#============================================================
...
echo "  Server: $(TEK_IP):$(TEK_PORT)"
echo "  Prefix: $(P)"
echo "  Poll Rate: $(POLL_TIME)s"
echo "  Measurements: $(NUM_MEAS)"
echo ""
echo "  Configured Devices:"
echo "    MEAS1: BEAMBPM01 (CH1)"
echo "    MEAS2: EOSPHD01 (CH2)"
echo "    MEAS3: PLADIS01 (CH3)"
echo "    MEAS4: PLALAS01 (CH4)"
echo "=========================================="
