...
dbLoadRecords("db/channel.template","P=$(P),SCANTIME=1 second,CHANAME=Trigger,CHANNEL=7,COEFF=1,PORT=inst0,NELM=10000")
dbLoadRecords("db/channel.template","P=$(P),SCANTIME=1 second,CHANAME=BCM,CHANNEL=8,COEFF=1,PORT=inst0,NELM=10000")
